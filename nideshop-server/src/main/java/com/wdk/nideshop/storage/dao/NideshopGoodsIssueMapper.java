...
public interface NideshopGoodsIssueMapper{
	 ...
	 * @return
	 */
	List<NideshopGoodsIssue> list(NideshopGoodsIssue param);
	 ...
	 * @return
	 */
	Integer count(NideshopGoodsIssue param);
	 ...
	 * @return
	 */
	int insertSelective(NideshopGoodsIssue param);
	 ...
	 * @return
	 */
	NideshopGoodsIssue selectByPrimaryKey(@Param("id") Integer param);
	 ...
	 * @return
	 */
	int updateSelectiveByPrimaryKey(NideshopGoodsIssue param);
