...
public interface NideshopBrandMapper{
	 ...
	 * @return
	 */
	List<NideshopBrand> list(NideshopBrand param);
	 ...
	 * @return
	 */
	Integer count(NideshopBrand param);
	 ...
	 * @return
	 */
	int insertSelective(NideshopBrand param);
	 ...
	 * @return
	 */
	NideshopBrand selectByPrimaryKey(@Param("id") Integer param);
	 ...
	 * @return
	 */
	int updateSelectiveByPrimaryKey(NideshopBrand param);
