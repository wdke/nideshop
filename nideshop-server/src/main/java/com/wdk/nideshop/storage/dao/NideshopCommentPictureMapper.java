...
public interface NideshopCommentPictureMapper{
	 ...
	 * @return
	 */
	List<NideshopCommentPicture> list(NideshopCommentPicture param);
	 ...
	 * @return
	 */
	Integer count(NideshopCommentPicture param);
	 ...
	 * @return
	 */
	int insertSelective(NideshopCommentPicture param);
	 ...
	 * @return
	 */
	NideshopCommentPicture selectByPrimaryKey(@Param("id") Integer param);
	 ...
	 * @return
	 */
	int updateSelectiveByPrimaryKey(NideshopCommentPicture param);
