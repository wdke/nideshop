...
public interface NideshopProductMapper{
	 ...
	 * @return
	 */
	List<NideshopProduct> list(NideshopProduct param);
	 ...
	 * @return
	 */
	Integer count(NideshopProduct param);
	 ...
	 * @return
	 */
	int insertSelective(NideshopProduct param);
	 ...
	 * @return
	 */
	NideshopProduct selectByPrimaryKey(@Param("id") Integer param);
	 ...
	 * @return
	 */
	int updateSelectiveByPrimaryKey(NideshopProduct param);
