...
public interface NideshopAdMapper{
	 ...
	 * @return
	 */
	List<NideshopAd> list(NideshopAd param);
	 ...
	 * @return
	 */
	Integer count(NideshopAd param);
	 ...
	 * @return
	 */
	int insertSelective(NideshopAd param);
	 ...
	 * @return
	 */
	NideshopAd selectByPrimaryKey(@Param("id") Short param);
	 ...
	 * @return
	 */
	int updateSelectiveByPrimaryKey(NideshopAd param);
