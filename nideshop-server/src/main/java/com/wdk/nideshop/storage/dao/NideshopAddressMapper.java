...
public interface NideshopAddressMapper{
	 ...
	 * @return
	 */
	List<NideshopAddress> list(NideshopAddress param);
	 ...
	 * @return
	 */
	Integer count(NideshopAddress param);
	 ...
	 * @return
	 */
	int insertSelective(NideshopAddress param);
	 ...
	 * @return
	 */
	NideshopAddress selectByPrimaryKey(@Param("id") Integer param);
	 ...
	 * @return
	 */
	int updateSelectiveByPrimaryKey(NideshopAddress param);
