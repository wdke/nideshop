...
public interface NideshopRelatedGoodsMapper{
	 ...
	 * @return
	 */
	List<NideshopRelatedGoods> list(NideshopRelatedGoods param);
	 ...
	 * @return
	 */
	Integer count(NideshopRelatedGoods param);
	 ...
	 * @return
	 */
	int insertSelective(NideshopRelatedGoods param);
	 ...
	 * @return
	 */
	NideshopRelatedGoods selectByPrimaryKey(@Param("id") Integer param);
	 ...
	 * @return
	 */
	int updateSelectiveByPrimaryKey(NideshopRelatedGoods param);
