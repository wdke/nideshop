...
public interface NideshopUserLevelMapper{
	 ...
	 * @return
	 */
	List<NideshopUserLevel> list(NideshopUserLevel param);
	 ...
	 * @return
	 */
	Integer count(NideshopUserLevel param);
	 ...
	 * @return
	 */
	int insertSelective(NideshopUserLevel param);
	 ...
	 * @return
	 */
	NideshopUserLevel selectByPrimaryKey(@Param("id") Byte param);
	 ...
	 * @return
	 */
	int updateSelectiveByPrimaryKey(NideshopUserLevel param);
