 ...
 */
package com.wdk.nideshop.common.aop.common.aop;

import com.wdk.nideshop.common.logger.AccessLog;
import com.wdk.nideshop.common.logger.TalStopWatch;
...
public class ActionAop {
	...
	@Pointcut("execution(* com.wdk.nideshop.service..*(..))")
	 ...
	 * @param joinPoint
	 */
	@Before(value = "execution(* com.wdk.nideshop.web..*(..))")
	 ...
	 * @param joinPoint
	 */
	@AfterReturning(value = "execution(* com.wdk.nideshop.web..*(..))", returning = "result")
