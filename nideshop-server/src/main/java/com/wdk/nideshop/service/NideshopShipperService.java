 ...
 * @date 2019/12/30
 */
public interface NideshopShipperService{
	...
	* @date 2019/12/30 19:37
	*/
	List<NideshopShipper> list(NideshopShipperArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	Integer count(NideshopShipperArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	PageInfo<NideshopShipper> pageInfo(NideshopShipperArgs param,PageParam pageParam);
	...
	* @date 2019/12/30 19:37
	*/
	int insertSelective(NideshopShipperArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	int updateSelectiveByPrimaryKey(NideshopShipperArgs param);
