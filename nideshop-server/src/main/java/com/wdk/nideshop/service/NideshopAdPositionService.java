 ...
 * @date 2019/12/30
 */
public interface NideshopAdPositionService{
	...
	* @date 2019/12/30 19:37
	*/
	List<NideshopAdPosition> list(NideshopAdPositionArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	Integer count(NideshopAdPositionArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	PageInfo<NideshopAdPosition> pageInfo(NideshopAdPositionArgs param,PageParam pageParam);
	...
	* @date 2019/12/30 19:37
	*/
	int insertSelective(NideshopAdPositionArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	int updateSelectiveByPrimaryKey(NideshopAdPositionArgs param);
