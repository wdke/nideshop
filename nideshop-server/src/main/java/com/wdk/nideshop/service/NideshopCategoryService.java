...
public interface NideshopCategoryService{
	...
	* @date 2019/12/30 19:37
	*/
	List<NideshopCategory> list(NideshopCategoryArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	Integer count(NideshopCategoryArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	PageInfo<NideshopCategory> pageInfo(NideshopCategoryArgs param,PageParam pageParam);
	...
	* @date 2019/12/30 19:37
	*/
	int insertSelective(NideshopCategoryArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	int updateSelectiveByPrimaryKey(NideshopCategoryArgs param);
