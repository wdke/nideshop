 ...
 * @date 2019/12/30
 */
public interface NideshopAttributeService{
	...
	* @date 2019/12/30 19:37
	*/
	List<NideshopAttribute> list(NideshopAttributeArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	Integer count(NideshopAttributeArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	PageInfo<NideshopAttribute> pageInfo(NideshopAttributeArgs param,PageParam pageParam);
	...
	* @date 2019/12/30 19:37
	*/
	int insertSelective(NideshopAttributeArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	int updateSelectiveByPrimaryKey(NideshopAttributeArgs param);
