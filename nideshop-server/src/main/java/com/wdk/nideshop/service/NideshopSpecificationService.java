 ...
 * @date 2019/12/30
 */
public interface NideshopSpecificationService{
	...
	* @date 2019/12/30 19:37
	*/
	List<NideshopSpecification> list(NideshopSpecificationArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	Integer count(NideshopSpecificationArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	PageInfo<NideshopSpecification> pageInfo(NideshopSpecificationArgs param,PageParam pageParam);
	...
	* @date 2019/12/30 19:37
	*/
	int insertSelective(NideshopSpecificationArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	int updateSelectiveByPrimaryKey(NideshopSpecificationArgs param);
