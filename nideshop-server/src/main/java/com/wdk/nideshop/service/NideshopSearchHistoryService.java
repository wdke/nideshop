 ...
 * @date 2019/12/30
 */
public interface NideshopSearchHistoryService{
	...
	* @date 2019/12/30 19:37
	*/
	List<NideshopSearchHistory> list(NideshopSearchHistoryArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	Integer count(NideshopSearchHistoryArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	PageInfo<NideshopSearchHistory> pageInfo(NideshopSearchHistoryArgs param,PageParam pageParam);
	...
	* @date 2019/12/30 19:37
	*/
	int insertSelective(NideshopSearchHistoryArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	int updateSelectiveByPrimaryKey(NideshopSearchHistoryArgs param);
