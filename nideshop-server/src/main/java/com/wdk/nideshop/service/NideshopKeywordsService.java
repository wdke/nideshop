 ...
 * @date 2019/12/30
 */
public interface NideshopKeywordsService{
	...
	* @date 2019/12/30 19:37
	*/
	List<NideshopKeywords> list(NideshopKeywordsArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	Integer count(NideshopKeywordsArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	PageInfo<NideshopKeywords> pageInfo(NideshopKeywordsArgs param,PageParam pageParam);
	...
	* @date 2019/12/30 19:37
	*/
	int insertSelective(NideshopKeywordsArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	int updateSelectiveByPrimaryKey(NideshopKeywordsArgs param);
