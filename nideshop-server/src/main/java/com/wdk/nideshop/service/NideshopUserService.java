...
public interface NideshopUserService{
	...
	* @date 2019/12/30 19:37
	*/
	List<NideshopUser> list(NideshopUserArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	Integer count(NideshopUserArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	PageInfo<NideshopUser> pageInfo(NideshopUserArgs param,PageParam pageParam);
	...
	* @date 2019/12/30 19:37
	*/
	int insertSelective(NideshopUserArgs param);
	...
	* @date 2019/12/30 19:37
	*/
	int updateSelectiveByPrimaryKey(NideshopUserArgs param);
